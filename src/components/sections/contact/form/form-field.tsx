...
const inputBaseClasses = cn(
  "rounded border p-2.5 text-lg font-crimson font-medium focus-within:outline-2",
  "border-black/20 bg-white/70 text-darkest placeholder:text-darkest/55 focus-within:outline-black/45",
  "dark:border-off-w/40 dark:bg-transparent dark:text-off-w dark:placeholder:text-off-w/55 dark:focus-within:outline-off-w/75",
  "placeholder:font-light placeholder:font-medium",
);

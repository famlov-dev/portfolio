...
import { isExperienceOpenAtom, currentExperienceAtom } from "@/lib/store/experience";
import { LanguageCode } from "@/lib/constants/langs";

import Image from "next/image";
import { ExperienceTag } from "./experience-tag";

export const ExperienceCard = ({ ...props }: ExperienceType) => {
  ...
  return (
    ...
    >
      <ExperienceTag status={props.status} />

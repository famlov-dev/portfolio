      ...
      <AnimatePresence>
        {isOpen && (
          <m.div
            ...
            className={cn(
              "absolute top-12 right-0 flex min-w-max flex-col gap-y-5 rounded-xl border border-black/25 p-4 shadow-xl backdrop-blur-lg",
          ...
          >
            {links.map((link) => (
              <a
                ...
                role="menuitem"
                className={cn(
                  "cursor-pointer self-start text-sm font-semibold tracking-wide uppercase",
